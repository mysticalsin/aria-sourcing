...
- **Live Fly:** `8b836d8` / **0073** · `deploy_status=tip_ahead_docs` (tip includes E2E honesty + HANDOFF)
...
bash scripts/print-fly-golive-status.sh   # tip_ahead_docs OK; live 8b836d8
