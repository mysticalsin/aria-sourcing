...
- **PR:** [#33](https://github.com/mysticalsin/aria-sourcing/pull/33) ready (**PR #32 closed**, supersedes #29–#31)
...
- After golive: **expect step 3c PASS** with `provenance=live` (step 3c FAIL on stale Fly when `live=0`); drop `ARIA_ALLOW_STALE_FLY_E2E=1`
