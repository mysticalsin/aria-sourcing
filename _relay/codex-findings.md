...
## 2026-07-26 - Planned 0068 evaluator cannot make indexed canonical lookups
**Severity:** correctness
**File:** _relay/plans/08-candidate-outreach-eligibility-authority.md
...
**Severity:** test-gap
**File:** tests/candidate-outreach-eligibility-db.sh
