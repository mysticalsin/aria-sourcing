...
- **Live Fly:** tip reminting after AppShell full-bleed for hub (product tip was `4b3b5ea` / **0071**)
...
5. AppShell full-bleed for hub/product/pricing/docs (no recruiter chrome)
6. Tests: `tests/candidate-hub.mts` registered in application manifest
...
# optional later: CAREERS_WORKSPACE_ID to re-enable /careers chatbox; ATS sync
```
