...
1. Graph dropzones → Connect Outlook live seat → email Autopilot `sent>0`
2. HeyReach portal: LI account + campaign `{message}` → Settings Save campaignId + live HeyReach seat
