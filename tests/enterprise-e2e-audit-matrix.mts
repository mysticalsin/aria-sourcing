  ...
  },
  {
    ...
    evidence: () => {
      ...
      return (
        ...
        && /\(\.status \/\/ "active"\) == "active"/.test(readFileSync("scripts/post-m365-secrets-golive.sh", "utf8"))
        && /Owners → Add twalteur@amaris\.com/.test(readFileSync("src/components/intake/outlook-needs-panel.tsx", "utf8"))
        && /Owners → Add twalteur@amaris\.com/.test(readFileSync("src/components/fleet/seat-card.tsx", "utf8"))
