...
begin
  for item in
    select * from (values
      ...
      ('public.read_workspace_campaign_for_loop(uuid,text)',                  'service_role',  true),
      ('public.read_workspace_candidates_for_loop(uuid,text[])',              'service_role',  true),
      ('public.read_workspace_booking_for_loop(uuid,text)',                   'service_role',  true),
      ('public.read_workspace_skills_for_loop(uuid)',                         'service_role',  true),
      ('public.read_workspace_outreach_for_loop(uuid,text,boolean,integer)',  'service_role',  true),
      ('public.read_workspace_candidate_outreach_for_loop(uuid,text,text)',   'service_role',  true),
      ('public.read_workspace_scoring_weights_for_loop(uuid)',                'service_role',  true),
      ('public.read_workspace_candidate_identities_for_loop(uuid,text,integer)', 'service_role', true),
      ...
      ('public.outbound_approval_authorizes_send(uuid,text,uuid,uuid,timestamptz)', 'authenticated', true),
      ('public.mint_template_bound_approval(uuid,text,text,text,uuid,uuid)',  'service_role',  true),
      ('public.mint_autopilot_critics_approval(uuid,text,text,text,uuid)', 'service_role', true),
      ('public.enqueue_email_outbound_service(uuid,text,text,text,uuid,text,text,text)', 'service_role', true),
      ('public.enqueue_whatsapp_outbound_service(uuid,text,text,text,uuid,text,text,text,text,uuid,jsonb)', 'service_role', true),
      ('public.enqueue_linkedin_outbound_service(uuid,text,text,text,uuid,text,text,text)', 'service_role', true),
  ...
  for item in
    select signature from (values
      ...
      ('public.read_workspace_campaign_for_loop(uuid,text)'),
      ('public.read_workspace_candidates_for_loop(uuid,text[])'),
      ('public.read_workspace_booking_for_loop(uuid,text)'),
      ('public.read_workspace_skills_for_loop(uuid)'),
      ('public.read_workspace_outreach_for_loop(uuid,text,boolean,integer)'),
      ('public.read_workspace_candidate_outreach_for_loop(uuid,text,text)'),
      ('public.read_workspace_scoring_weights_for_loop(uuid)'),
      ('public.read_workspace_candidate_identities_for_loop(uuid,text,integer)'),
