...
begin
  for item in
    select * from (values
      ...
      ('public.claim_linkedin_connect(uuid)',                                 'service_role',  true),
      ('public.record_linkedin_connect_outcome(uuid,uuid,text,text,text)',     'service_role',  true),
  ...
  for item in
    select signature from (values
      ...
      ('public.claim_linkedin_connect(uuid)'),
      ('public.record_linkedin_connect_outcome(uuid,uuid,text,text,text)'),
