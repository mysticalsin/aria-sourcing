...
const sampleProfile: ApifyProfile = {
  ...
  firstName: "Jane",
  lastName: "Doe",
  headline: "Senior Backend Engineer — Go, Kubernetes, PostgreSQL",
  about: "Go Kubernetes PostgreSQL gRPC Distributed Systems engineer in Paris",
  location: { text: "Paris, France", countryCode: "FR" },
  connectionsCount: 500,
  followerCount: 500,
  currentPosition: [{ title: "Senior Backend Engineer", companyName: "Example Corp", dateRange: "2022 - Present" }],
  experience: [],
  education: [],
