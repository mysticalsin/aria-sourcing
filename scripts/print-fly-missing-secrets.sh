...
echo "=== aria-mantu-app ==="
for name in DATA_ENCRYPTION_KEY EMAIL_INBOUND_WEBHOOK_SECRET MICROSOFT_CLIENT_ID MICROSOFT_CLIENT_SECRET MICROSOFT_REDIRECT_URI MICROSOFT_TENANT_ID ARIA_LOOP_KILL_SWITCH; do
