...
const FINANCE_SIGNALS =
  /\b(murex|calypso|finance|financial|pricing|trading|front office|risk|valuation|capital markets|bonds|derivatives|quant|mx\.iii|treasury|bank|business analysis|business analyst|settlements|cib)\b/i;
