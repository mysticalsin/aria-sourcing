  ...
  return [
    {
      ...
      content: [
        ...
        "- Always run the Humanizer before send: no em dashes, no en dashes used as pauses, no AI filler.",
        "- Write like a real recruiter texting a peer: concrete, warm, no corporate fog.",
        "- Prefer Connect + note when Message is unavailable; keep the note under LinkedIn's limit.",
      ].join("\n"),
      version: 1,
    ...
    },
    {
      ...
      content: [
        ...
        "- Optional ICP / profile analyzers (Orca-style, Linki, OpenOutreach) may score public URLs when enabled; LinkedIn Connect/Message still runs on AriaBot computers only.",
        "- Optional browser-use sidecars never replace AriaBot Take control for LinkedIn sessions.",
