  ...
  return (
    <>
      <PageHeader
        ...
        description="Every message is drafted by the system and held here for your sign-off. Nothing ships live — approvals schedule a dry-run."
        actions={
            ...
            <section className="space-y-4">
              ...
              >
                <span className="flex items-center gap-3">
                  ...
                  <span>
                    <span className="block text-sm font-bold text-ink">Sent (dry-run)</span>
                    <span className="block text-xs text-muted">
                      Approved &amp; scheduled — nothing sent live
                    </span>
                  </span>
                </span>
              ...
              {sentOpen &&
                (scheduledFiltered.length === 0 ? (
                  <p className="px-1 text-sm text-muted">
                    Nothing scheduled yet. Approved messages will appear here as dry-run sends.
                  </p>
                ) : (
            ...
            <Card>
              <CardContent className="space-y-4">
                ...
                <p className="flex items-start gap-1.5 border-t border-line pt-4 text-xs text-muted">
                  ...
                  Approving schedules a dry-run only. Personalization is required before any message
                  can be approved.
                </p>
              </CardContent>
            </Card>
