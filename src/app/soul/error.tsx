...
/**
 * Route-segment error boundary for /soul. Scopes a crash in the persona
 * editor to this segment instead of blanking the whole app. Never surfaces
...
export default function Error({
  ...
  return (
    ...
    >
      ...
      <h1 className="display text-4xl text-ink">The soul view hit an unexpected error.</h1>
      <p className="mt-3 max-w-md text-muted">
        Aria couldn’t finish rendering the persona editor. Your data is safe, so try again, or
