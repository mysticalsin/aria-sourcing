...
/**
 * Route-segment error boundary for /skills. Scopes a crash in the
 * self-improvement / learning-proposal view to this segment instead of
 * blanking the whole app. Never surfaces error.message / stack to end
...
export default function Error({
  ...
  return (
    ...
    >
      ...
      <h1 className="display text-4xl text-ink">The skills view hit an unexpected error.</h1>
      <p className="mt-3 max-w-md text-muted">
        Aria couldn’t finish rendering the learning playbooks. Your data is safe, so try again, or
