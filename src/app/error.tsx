...
/**
 * Route-segment error boundary. Catches render/runtime errors thrown within the
 * app shell so a single broken view degrades to a recoverable panel instead of a
