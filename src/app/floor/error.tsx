...
/**
 * Route-segment error boundary for /floor. Scopes a crash in the heavy 3D
 * office view (WebGL/three.js) to this segment instead of blanking the whole
 * app. Never surfaces error.message / stack to end users in production — the
 * real error is logged to the console for developers only.
 */
export default function Error({
  ...
  return (
    ...
    >
      ...
      <h1 className="display text-4xl text-ink">The floor view hit an unexpected error.</h1>
      <p className="mt-3 max-w-md text-muted">
        Aria couldn’t finish rendering the 3D floor. Your data is safe, so try again, or
