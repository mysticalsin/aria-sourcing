...
/**
 * Route-segment error boundary for /fleet. Scopes a crash in seat mutation,
 * LLM provider/model assignment, or allocation logic to this segment instead
 * of blanking the whole app. Never surfaces error.message / stack to end
 * users in production — the real error is logged to the console for
 * developers only.
 */
export default function Error({
  ...
  return (
    ...
    >
      ...
      <h1 className="display text-4xl text-ink">The fleet view hit an unexpected error.</h1>
      <p className="mt-3 max-w-md text-muted">
        Aria couldn’t finish rendering the agent roster. Your data is safe, so try again, or
