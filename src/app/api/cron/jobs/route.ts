...
const LOOP_CRON_JOBS = [
  ...
  { id: "interview-prep-dispatch", path: "/api/cron/interview-prep-dispatch", schedule: "loop worker", description: "Post-booking prep drafts + live critics (Autopilot queues when entitled)" },
  ...
  { id: "autopilot-send-outreach", path: "/api/cron/autopilot-send-outreach", schedule: "loop worker", description: "REI Autopilot send + ready-draft sweep after critics-green" },
