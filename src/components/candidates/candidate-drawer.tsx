...
export function CandidateDrawer({
  ...
  // 2026-07-15-enrichment-orchestrator.md) — replaces the old single-provider
  // Apollo/Seamless buttons. Runs the cost-ordered waterfall across every
  // configured provider that can identify this candidate, regardless of which
  // platform originally sourced them.
