-- 0062_orphan_owner_recovery_auth_bridge.sql rollback
--
-- Restore the 0031 recovery function exactly, including its direct Auth-owner
-- inventory and identity validation, then restore the postgres owner and ACL.
